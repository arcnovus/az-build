...
# =============================================================================
# This file contains utility functions and implementation-derived values.
# Do not edit this file - it is automatically sourced by config.sh.
# =============================================================================
...
# =============================================================================
# These values are computed from user configuration and must be in specific formats
# for Azure APIs. Do not modify these formulas.

# Constructed billing scope (Azure API path format - do not modify structure)
export BILLING_SCOPE="/providers/Microsoft.Billing/billingAccounts/${BILLING_ACCOUNT_ID}/billingProfiles/${BILLING_PROFILE_ID}/invoiceSections/${INVOICE_SECTION_ID}"
